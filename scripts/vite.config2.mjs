...
export default defineConfig({
  ...
  build: {
    ...
    rollupOptions: {
      // 👇 'zarrita' has been added here to exclude it from the bundle.
      external: ['react', 'react-dom', 'zarrita', ...moreExternals],
      ...
      output: {
        globals: {
          react: 'React',
          'react-dom': 'ReactDOM',
          zarrita: 'Zarrita', // Add its global name if you use UMD/IIFE formats later
        },
      },
      */
    },
